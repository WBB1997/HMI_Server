package com.wubeibei.hmi_server.transmit.bean;
...
public class IntegerCommand {
    ...
    public static final int SystemStatus = 87; //自动驾驶状态
    ...
    public static final int SWP_ProjectorVideobackStatus = 91; //投影仪视频播放状态
}
