...
public class BMS7 extends BaseClass {
    ...
    private HashMap<Integer, MyPair<Integer>> fields = new HashMap<Integer, MyPair<Integer>>() {{
        put(0, new MyPair<>(16, IntegerCommand.can_num_HVMaxTemp, SendFlag.LOCALHOST)); // 最高单体温度
        put(16, new MyPair<>(16, IntegerCommand.can_num_HVMinTemp, SendFlag.LOCALHOST)); // 最低单体温度
        put(48, new MyPair<>(16, IntegerCommand.can_num_PackAverageTemp, SendFlag.LOCALHOST)); // 电池包平均温度
    }};
    ...
    public Object getValue(Map.Entry<Integer, MyPair<Integer>> entry, byte[] bytes) {
        ...
        switch (index) {
            ...
            case 16:
            case 48:
                return countBits(bytes, 0, index, 16, getState()) * 0.1 - 40;
            default:
